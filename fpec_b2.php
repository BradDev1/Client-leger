						...
						<div class='dashboard-nav-dropdown active'>
							<a class="dashboard-nav-item dashboard-nav-dropdown-toggle">
								...
								<div class='dashboard-nav-dropdown-menu'>
									...
									<a class="dashboard-nav-dropdown-item active">Devis proposé</a>
							...
							<div class='container'>
								<div class='card'>
									<div class='card-header'>
										<h1>Liste Devis proposé de fiche pec de <?php echo $user['nom'] ?> </h1>
									</div>
									<div class='card-body'>
										<?php
										$sql = 'SELECT DISTINCT * FROM fiche_peg where status = "B2 Devis proposé" and id_client = '.$_GET['id'].'';
										?>
											...
											<table class="table">
												...
												<tbody>
													...
													foreach ($bdd->query($sql) as $row) {
														...
														<td><a href="supprimer4.php?id=<?php echo $row['id_inter'] ?>">Supprimer</a></td>
													</tr>
														<?php
