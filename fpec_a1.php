					...
					<div class='dashboard-nav-dropdown active'>
						<a class="dashboard-nav-item dashboard-nav-dropdown-toggle">
							...
							<div class='dashboard-nav-dropdown-menu '>
								...
								<a class="dashboard-nav-dropdown-item active">Réception</a>
						...
						<div class='container'>
							<div class='card'>
								<div class='card-header'>
									<h1>Liste réception de fiche pec de <?php echo $user['nom'] ?> </h1>
								</div>
								<div class='card-body'>
									<?php
									$sql = 'SELECT DISTINCT * FROM fiche_peg where status = "A1 Réception" and id_client = '.$_GET['id'].'';
									?>
