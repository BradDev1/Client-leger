						...
						<div class='dashboard-nav-dropdown'>
							...
							<div class='dashboard-nav-dropdown active'>
								...
								<div class='dashboard-nav-dropdown-menu'>
									...
									<a class="dashboard-nav-dropdown-item active">PC FIXE</a>
							...
							<div class='container'>
								<div class='card'>
									<div class='card-header'>
										<h1>Liste pc fixe de <?php echo $user['nom'] ?></h1>
									</div>
									<div class='card-body'>
										<?php
										$sql = 'SELECT DISTINCT * FROM ordinateur where type = "Pc fixe" and id_client = '.$_GET['id'].'';
										?>
