					...
					<div class='dashboard-nav-dropdown '>
						...
						<div class='dashboard-nav-dropdown active'>
							...
							<div class='dashboard-nav-dropdown-menu'>
								...
								<a class="dashboard-nav-dropdown-item active">Abonné(e)</a>
							...
							<div class='container'>
								<div class='card'>
									<div class='card-header'>
										<h1>Liste client abonné(e)</h1>
									</div>
									<div class='card-body'>
										<?php
										$sql = 'SELECT * FROM clients where status = "Abonné(e)"';
										?>
