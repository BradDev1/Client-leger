						...
						<div class='container'>
							<div class='card'>
								<div class='card-header'>
									<h1>Liste compléte des fiches fpec </h1>
								</div>
								<div class='card-body'>
									<?php
									$sql = 'SELECT DISTINCT * FROM fiche_peg ORDER BY status ASC';
									?>
											...
											<tbody>
												...
												<tr>
													...
													foreach ($bdd->query($sql) as $row) {
														...
														<td><a href="supprimer2.php?id=<?php echo $row['id_inter'] ?>">Supprimer</a></td>
													</tr>
													<?php 
