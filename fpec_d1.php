						...
						<div class='dashboard-nav-dropdown active'>
							<a class="dashboard-nav-item dashboard-nav-dropdown-toggle">
								...
								<div class='dashboard-nav-dropdown-menu'>
									...
									<a class="dashboard-nav-dropdown-item active">Livraison</a>
								</div>
							</div>
							...
							<div class='container'>
								<div class='card'>
									<div class='card-header'>
										<h1>Liste Livraison de fiche pec de <?php echo $user['nom'] ?> </h1>
									</div>
									<div class='card-body'>
										<?php
										$sql = 'SELECT DISTINCT * FROM fiche_peg where status = "D1 Livraison" and id_client = '.$_GET['id'].''; 
										?>
