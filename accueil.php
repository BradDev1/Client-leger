...
if(isset($_GET['nom']) and !empty($_GET['nom'])) {
	$recherche = htmlspecialchars($_GET['nom']);
	$requser = $bdd->query('SELECT * FROM clients WHERE nom LIKE "%'.$recherche.'%"');
}
?>
			...
			<div class="dashboard-nav">
				<header>
					...
					<nav class="dashboard-nav-list">
						<a class="dashboard-nav-item active"><i class="fas fa-tachometer-alt"></i> Dashboard
						</a><a
						...
						<div class='dashboard-content'>
							<div class='container'>
								<div class='card'>
									...
									<div class='card-body'>
										<input type="text" name="nom" autocomplete="off" class="form-control" placeholder="Recherchez votre client"><?php include"research.php";?>
									</div>
								</div>
							</div>
						</div>
